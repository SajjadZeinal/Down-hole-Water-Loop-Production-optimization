...
global FineMode
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Optimization\Sequential\Data\Wojtanovic.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Optimization\Sequential\Data\Wojtanovic.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Optimization\Sequential\Data\Wojtanovic.RSM');
A=fscanf(fileID,'%c');
