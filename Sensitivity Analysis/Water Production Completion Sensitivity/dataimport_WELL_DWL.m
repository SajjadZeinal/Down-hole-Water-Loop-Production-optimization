...
fileID=fopen('G:\Sajjad\Sensitivity Analysis\Water Production Completion\Data file\150-R.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('G:\Sajjad\Sensitivity Analysis\Water Production Completion\Data file\150-R.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('G:\Sajjad\Sensitivity Analysis\Water Production Completion\Data file\150-R.RSM');
A=fscanf(fileID,'%c');
