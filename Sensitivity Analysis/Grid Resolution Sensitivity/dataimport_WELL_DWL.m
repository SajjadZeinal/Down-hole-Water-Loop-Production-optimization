...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Sensitivity\Grid Sensitivity\R Direction\204 R Grids\204-R.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Sensitivity\Grid Sensitivity\R Direction\204 R Grids\204-R.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Sensitivity\Grid Sensitivity\R Direction\204 R Grids\204-R.RSM');
A=fscanf(fileID,'%c');
