...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Sensitivity\Grid Sensitivity\R Direction\51R Grids\Wojtanovic.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Sensitivity\Grid Sensitivity\R Direction\51R Grids\Wojtanovic.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Sensitivity\Grid Sensitivity\R Direction\51R Grids\Wojtanovic.RSM');
A=fscanf(fileID,'%c');
