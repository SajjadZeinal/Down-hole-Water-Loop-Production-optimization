...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Sensitivity\Anisotropy Sensitivity\KvKh=0.8\KvKh=0.8.data','r');
...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Sensitivity\Anisotropy Sensitivity\KvKh=0.8\KvKh=0.8.data','w');
fwrite(fid,SCHEDULE_OUT);
fclose(fid);
system('"C:\ecl\macros\eclrun.exe" eclipse "H:\Univercity documents\master\Project\Work over\Final\DWL\Sensitivity\Anisotropy Sensitivity\KvKh=0.8\KvKh=0.8.data"');
