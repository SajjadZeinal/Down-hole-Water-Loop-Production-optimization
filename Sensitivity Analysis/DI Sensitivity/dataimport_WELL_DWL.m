...
fileID=fopen('E:\Sajjad\DWL\Sensitivity\DI Spacing Sensitivity\Data\150-R.PRT');
A3=fscanf(fileID,'%c');
...
fileID=fopen('E:\Sajjad\DWL\Sensitivity\DI Spacing Sensitivity\Data\150-R.FUNSMRY');
A2=fscanf(fileID,'%c');
...
fileID=fopen('E:\Sajjad\DWL\Sensitivity\DI Spacing Sensitivity\Data\150-R.RSM');
A=fscanf(fileID,'%c');
