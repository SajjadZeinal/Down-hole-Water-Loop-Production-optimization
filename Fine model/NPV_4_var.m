...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Optimization\GA PROGRAM next Cross-DI\GA Program\Data file\Wojtanovic.data','r');
...
fid=fopen('H:\Univercity documents\master\Project\Work over\Final\DWL\Optimization\GA PROGRAM next Cross-DI\GA Program\Data file\Wojtanovic.data','w');
fwrite(fid,SCHEDULE_OUT);
fclose(fid);
system('"C:\ecl\macros\eclrun.exe" eclipse "H:\Univercity documents\master\Project\Work over\Final\DWL\Optimization\GA PROGRAM next Cross-DI\GA Program\Data file\Wojtanovic.data"');
